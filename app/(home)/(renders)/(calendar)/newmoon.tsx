  ...
  return (
    <View style={styles.container}>
      <View style={{ width: "100%", marginBottom: 20, alignItems: "center" }}>
        ...
        >
          View monthly new moon dates to easily determine the exact time for
          observing the New Moon Sabbath.
        </Text>
      </View>
        ...
        >
          {dateList.map((moon, index) => (
            ...
            >
              <Text
                allowFontScaling={false}
                style={[styles.textDate, { color: themeColors.primaryText }]}
              >
                {moon.date}
              </Text>
              <Text
                allowFontScaling={false}
                style={[styles.textTime, { color: themeColors.secondaryText }]}
              >
                {moon.time}
              </Text>
              {index === currentDate && (
